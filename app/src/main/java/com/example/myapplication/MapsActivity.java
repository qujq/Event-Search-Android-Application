            ...
            button_go_back_search_result.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(fromFavorite){
                        ...
                        Intent intent = new Intent(MapsActivity.this, SearchResult.class);
...
//            venue_child_rule_textview.setVisibility(View.GONE);
            ...
            ScrollView scroll_view_venue = findViewById(R.id.scroll_view_venue);
...
//                        venue_child_rule_content_textview.setVisibility(View.VISIBLE);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        double lat = Double.valueOf(venue_location_latitude);
        double lng = Double.valueOf(venue_location_longitude);
